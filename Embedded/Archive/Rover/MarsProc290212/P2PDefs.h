...
//    #define EXPLORER16
    ...
    #define PHY_WAKE LATDbits.LATD2
    #define PHY_WAKE_TRIS TRISDbits.TRISD2
    
    #define PUSH_BUTTON_1 PORTBbits.RB5
    #define PUSH_BUTTON_2 PORTBbits.RB4
    #define LED_1 PORTDbits.BD0
    #define LED_2 PORTDbits.BD1
...
/*********************************************************************/
    ...
    #define P2P_CAPACITY_INFO               0x09
#else
    #define P2P_CAPACITY_INFO               0x0A
#endif
...
/*********************************************************************/
// ENABLE_BROADCAST will enable to device to broadcast messages for
